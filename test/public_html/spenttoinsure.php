        ...
        <body class="hold-transition skin-blue sidebar-mini">
            <div class="wrapper">
                <div class="content-wrapper">
                    ...
                    <h1> Record Amount spent to insure</h1>
                        <ol class="breadcrumb">
                                    ...
                                    $message = '';
                                     ...
                                     if (empty($id)||
                                          ...
                                          )
                                        {
                                            ...
                                            $sql="INSERT INTO spent_on_insuree (nat_id, amount, pay_date) VALUES ('$id', '$amount', '$pay_date') ";
                            ...
                            ?>
                              ...
                              <form  method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" name="id" required="require">
                                </div>
                                <div class="form-group">

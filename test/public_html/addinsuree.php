        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            <div class="box-header with-border">
              <h3 class="box-title">Add Loan Client</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
...
//this enters members data for registration into the system
 ...
 {   include 'partials/connection.php';
        ...
        ) 
    {
        ...
        $exist = "SELECT * FROM insurees WHERE nat_id = $id ";
        $result = mysqli_query($conn,$exist) or die (mysqli_connect_error());
        $results = mysqli_num_rows($result);
           if ($results < 1) 
           {
                $sql = "INSERT INTO insurees (nat_id, name, phone, email, estate, work, occupation, class)
                 VALUES ('$id', '$name','$phone', '$email', '$estate', '$work', '$occupation','$class') ";
...
?>    
                          <form  method="POST">
                                ...
                                <div class="form-group">
                                    <label for="class">Insurance Class</label>

                            ...
                            <div class="col-xs-12">
                                <div class="box">
                                    <div class="box-header">
                                        <h3 class="box-title">All Premium payments</h3>
                                    </div>
                                    <!-- /.box-header -->
                                    <div class="box-body">
                	                    ...
                	                    <?php
        				                    ...
        				                    $sql = "SELECT * FROM premiums ORDER BY dis_no DESC";
                                        ...
                                        <tr>
                                            <td><a href="insureeaccounts.php<?php echo '?id='.$row['nat_id']; ?>"><?php echo $row['nat_id'];?></a></td>
